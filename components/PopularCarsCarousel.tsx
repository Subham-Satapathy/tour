    ...
    <div className="relative z-10">
      ...
      <div className="overflow-hidden">
        <div
          ...
          style={{ transform: `translateX(-${currentIndex * (100 / visibleVehicles)}%)` }}
        >
          {vehicles.map((vehicle) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* Specs */}
                  <div className="flex justify-between mb-6 bg-gray-50 rounded-xl p-4 border border-gray-100">
                    {vehicle.mileage && (
                      <div className="flex flex-col items-center">
                        <svg className="w-5 h-5 mb-1.5 text-black" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M13 10V3L4 14h7v7l9-11h-7z" />
                        </svg>
                        <span className="text-xs text-gray-700 font-semibold">{vehicle.mileage}</span>
                      </div>
                    )}
                    {vehicle.fuelType && (
                      <div className="flex flex-col items-center">
                        ...
                        <span className="text-xs text-gray-700 font-semibold">{vehicle.fuelType}</span>
                      </div>
                    )}
                    {vehicle.transmissionType && (
                      <div className="flex flex-col items-center">
                        ...
                        <span className="text-xs text-gray-700 font-semibold">{vehicle.transmissionType}</span>
                      </div>
                    )}
                    {vehicle.seatingCapacity && (
                      <div className="flex flex-col items-center">
                        ...
                        <span className="text-xs text-gray-700 font-semibold">{vehicle.seatingCapacity} seats</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-3xl font-black text-black tracking-tight">₹{vehicle.ratePerDay}</p>
