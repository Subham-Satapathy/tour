...
export async function PopularCars() {
  ...
  return (
    <section id="vehicles" className="py-16 md:py-24 bg-white dark:bg-black overflow-hidden scroll-mt-20">
        ...
        <div className="px-4 sm:px-6 lg:px-16 flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-16">
          <div>
            <div className="inline-block mb-3 md:mb-4">
              ...
              <p className="text-base md:text-lg lg:text-xl font-medium tracking-wide text-gray-600 dark:text-gray-400">Premium Fleet</p>
            </div>
          ...
          <Link href="/vehicles" className="mt-6 md:mt-0 px-8 py-4 bg-black dark:bg-white rounded-full font-semibold text-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200 active:scale-95 transition-all duration-200 shadow-lg flex items-center gap-2 cursor-pointer">
            Open Fleet
