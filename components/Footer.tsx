        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 px-6 sm:px-8 lg:px-12 xl:px-16 py-8 sm:py-10 lg:py-12 xl:py-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 xl:gap-16 mb-8 sm:mb-10 lg:mb-12">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-xs sm:text-sm leading-relaxed text-gray-600 mb-6 sm:mb-8 max-w-xs">
              ...
              <div className="flex gap-3 sm:gap-4">
                <a href="https://twitter.com/trivenitours" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900 transition-colors cursor-pointer">
                ...
                <a href="https://instagram.com/trivenitours" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900 transition-colors cursor-pointer">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                ...
                <a href="https://facebook.com/trivenitours" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900 transition-colors cursor-pointer">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/>
                  </svg>
                </a>
                <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900 transition-colors cursor-pointer">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            ...
            {Object.entries(footerLinks).map(([title, links]) => (
              <div key={title}>
                <h3 className="text-gray-900 font-bold text-xs sm:text-sm mb-4 sm:mb-5">{title}</h3>
                  ...
                  {links.map((link) => (
                    <li key={link.name}>
                      <a 
                        ...
                        className="text-gray-600 hover:text-gray-900 transition-colors text-xs sm:text-sm cursor-pointer block break-words"
                      >
                        {link.name}
                      </a>
                    </li>
