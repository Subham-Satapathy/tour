      ...
      <div className="mb-8 space-y-4">
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            ...
            className="px-6 py-3 bg-black text-white rounded-lg font-semibold hover:bg-gray-800 transition-all flex items-center justify-center gap-2 w-full sm:w-auto cursor-pointer"
          >
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          ...
          {hasActiveFilters && (
            <button
              onClick={clearFilters}
              className="px-6 py-3 bg-black text-white rounded-lg font-semibold hover:bg-gray-800 transition-all cursor-pointer"
            >
              Clear All Filters
            </button>
          )}
